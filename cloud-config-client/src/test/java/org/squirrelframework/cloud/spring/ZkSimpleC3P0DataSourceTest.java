 ...
 */
public class ZkSimpleC3P0DataSourceTest extends AbstractSimpeDataSourceTest {
    String normalConfig = "{\n" +
    ...
    protected void prepareZk(String config) throws Exception {
        ...
        applicationContext = new ClassPathXmlApplicationContext("classpath:c3p0-simple-ds-context.xml");
    }

    @Test
    public void testSimpleC3P0DataSource() throws Exception {
